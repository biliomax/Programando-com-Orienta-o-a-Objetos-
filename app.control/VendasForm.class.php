...
class VendasForm extends TPage {
    ...
    /**
     * método onReload()
     * ccarrega a DataGrid com os objetos
     */
    function onReload(){
        ...
        if($list){
            ...
            // inicia a transaçõa com o banco de 'my_livro'
    ...
    /**
     * método onFinal()
     * executada quando o usuário finaliza a Venda
     */
    function onFinal(){
        ...
        // inicia a transação com o banco 'my_livro'
        TTransaction::open('my_livro');
