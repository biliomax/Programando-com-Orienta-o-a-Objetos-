...
final class Produto {
    ...
    /**
     * método adcionar
     * adciona um produto ao registro
     * @param $descricao = desrição do produto
     * @param $estoque    = estoque atual
     * @param $preco_custo= preco de custo
     */
    public function adcionar($id, $descricao, $estoque, $preco_custo){
...
$produto->adcionar(1, 'Vinho', 10, 15);
$produto->adcionar(2, 'Salame', 20, 20);
